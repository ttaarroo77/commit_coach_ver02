...
var UpdateUserUseCase = /** @class */ (function () {
    function UpdateUserUseCase(userRepository) {
     ...
     * @returns 更新されたユーザー
     */
    UpdateUserUseCase.prototype.execute = function (id, input) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, userWithEmail, updatedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.userRepository.update(id, input)];
                    case 4:
                        updatedUser = _a.sent();
