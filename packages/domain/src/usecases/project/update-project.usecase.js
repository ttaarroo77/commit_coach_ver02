...
var UpdateProjectUseCase = /** @class */ (function () {
    function UpdateProjectUseCase(projectRepository) {
     ...
     * @returns 更新されたプロジェクト
     */
    UpdateProjectUseCase.prototype.execute = function (id, input) {
        return __awaiter(this, void 0, void 0, function () {
            var existingProject, updatedProject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.projectRepository.update(id, input)];
                    case 2:
