...
var CreateProjectUseCase = /** @class */ (function () {
    function CreateProjectUseCase(projectRepository) {
     ...
     * @returns 作成されたプロジェクト
     */
    CreateProjectUseCase.prototype.execute = function (input) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.projectRepository.create(input)];
                    case 1:
                        project = _a.sent();
