          ...
          <CardContent>
            {success ? (
              <div className="space-y-4">
                ...
                <Button
                  className="w-full bg-[#31A9B8] hover:bg-[#2a8f9c] text-white"
                  onClick={() => {
                    if (mounted && router) {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {((mounted && auth.error) || validationError) && (
                  <Alert variant="destructive">
                    <AlertDescription>{validationError || (mounted ? auth.error : null)}</AlertDescription>
                  </Alert>
                )}
                ...
                <Button type="submit" className="w-full bg-[#31A9B8] hover:bg-[#2a8f9c] text-white" disabled={mounted && auth.loading}>
