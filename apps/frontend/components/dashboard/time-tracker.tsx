...
import { FadeIn, SlideUp, StaggerContainer, StaggerItem, motion } from '@/components/ui/animations';
        ...
        <div className="space-y-4">
          ...
          <SlideUp delay={0.4}>
            <div className="flex items-center gap-3">
              ...
              <motion.span
                ...
                transition={{ duration: 0.5, repeat: Infinity, repeatDelay: 30 }}
              >
                {formattedTime}
              </motion.span>
            </div>
          ...
          <SlideUp delay={0.5}>
            <div className="mt-4">
              ...
              <div className="relative h-2 overflow-hidden bg-gray-200 dark:bg-gray-700 rounded-full">
                <motion.div
