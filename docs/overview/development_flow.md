...
- [ ] **21** `/login` ページ – Email/PW フォーム (2025-04-27)
- [ ] **22** `useAuth` Context (Supabase) (2025-04-27)
- [ ] **23** JWT を Cookie 保存 (2025-04-27)
- [ ] **24** `/logout` 処理 (2025-04-27)
- [ ] **25** 認証ガード (Next.js middleware) (2025-04-28)
- [ ] **26** `/register` & `/password/reset` ページ (2025-04-27)
- [ ] **27** react-hook‑form + zod バリデーション (2025-04-27)
...
- [ ] **33** 今日のタスク / 期限間近カード (2025-04-28)
- [ ] **34** 時計 & mini‑calendar (2025-04-28)
